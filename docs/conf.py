# -*- coding: utf-8 -*-
#
# tfl-training-ml-control documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = "https://github.com/aai-institute/tfl-training-ml-control/blob/master"
    if domain != "py":
        return None
    if not info["module"]:
        return None
...
htmlhelp_basename = "tfl-training-ml-control_doc"
...
man_pages = [("index", "tfl-training-ml-control", "", ["appliedAI TransferLab"], 1)]
